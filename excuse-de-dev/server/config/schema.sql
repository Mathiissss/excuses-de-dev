...
CREATE INDEX IF NOT EXISTS idx_excuses_http_code ON excuses(http_code);
CREATE INDEX IF NOT EXISTS idx_excuses_tag ON excuses(tag);
...
ON CONFLICT (http_code) DO NOTHING;

SELECT COUNT(*) as total_excuses FROM excuses;